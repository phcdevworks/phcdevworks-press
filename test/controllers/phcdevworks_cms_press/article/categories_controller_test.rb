  ...
  class Article::CategoriesControllerTest < ActionDispatch::IntegrationTest
    ...
    test "should create article_category" do
      assert_difference('Article::Category.count') do
        post article_categories_url, params: { article_category: { category_name: @article_category.category_name } }
      end
    ...
    test "should update article_category" do
      patch article_category_url(@article_category), params: { article_category: { category_name: @article_category.category_name } }
